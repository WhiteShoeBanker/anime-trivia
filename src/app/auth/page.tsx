...
// Apple Sign-In is gated until the provider is configured in the Supabase
// dashboard (Project → Authentication → Providers → Apple). Configuration
// requires Apple Developer credentials: Services ID, Team ID, Key ID, and
// .p8 private key. Flip this to true once the dashboard config is in place.
