...
VALUES (
  ...
  'multiple_choice',
  'impossible',
  '[{"text":"Gelus owned it first and personally handed the notebook down to Ryuk","isCorrect":false},{"text":"Ryuk always owned it — he stole a second notebook","isCorrect":false},{"text":"Sidoh","isCorrect":true},{"text":"Nu","isCorrect":false}]'::jsonb,
...
VALUES (
  ...
  'multiple_choice',
  'impossible',
  '[{"text":"Tetsurō Araki","isCorrect":true},{"text":"Mamoru Hosoda","isCorrect":false},{"text":"Shinichiro Watanabe","isCorrect":false},{"text":"Takeshi Obata","isCorrect":false}]'::jsonb,
